---
title: Novita AI
description: Instrument Novita AI calls and send traces to OpenObserve via OpenTelemetry.
---
...
* A [Novita AI](https://novita.ai/) API key
...
![Novita AI trace in OpenObserve](../../../images/integration/ai/novita.png)
