...
These integrations use OpenTelemetry at the gateway or client boundary, depending on the gateway. You can inspect traces across the underlying models and providers without relying on a single vendor's observability format.

## Gateway Integration Guides

- [Anannas](anannas.md)
- [AISIX AI Gateway](aisix-ai-gateway.md)
