...
| ----- | ----- |
| `llm_model_name` | Resolved model name (e.g. `gpt-4o-mini-2024-07-18`) |
| `llm_request_parameters_model` | Requested model (e.g. `gpt-4o-mini`) |
...
![Portkey trace in OpenObserve](../../../images/integration/ai/portkey.png)
