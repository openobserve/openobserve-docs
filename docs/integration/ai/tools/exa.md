...
| ----- | ----- |
| `exa_query` | The semantic search query string |
| `exa_num_results` | Number of results requested |
| `exa_result_count` | Number of results returned |
...
![Exa search trace in OpenObserve](../../../images/integration/ai/exa.png)
