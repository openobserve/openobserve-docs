...
:::accordion[Step 1: Connect to EC2 Instance]
...
:::accordion[Step 2: Install OpenObserve Collector]
...
:::accordion[Step 4: Generate Test Data (Optional)]
...
:::accordion[Step 5: Verify Ingestion]
