---
title: Ansible
metaTitle: Ansible Logs Integration Guide
...
:::accordion[Step 1: Configure Ansible log File]
...
:::accordion[Step 2: Create a Local Ansible Task (Optional)]
...
:::accordion[Step 3: Install Fluent Bit on Ubuntu]
...
:::accordion[Step 4: Configure Fluent Bit for Ansible Logs]
...
:::accordion[Step 5: Start Fluent Bit]
...
:::accordion[No logs in OpenObserve?]
...
:::accordion[Ansible log file not updating?]
...
:::accordion[Fluent Bit not picking up logs?]
