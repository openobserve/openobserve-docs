...
:::accordion[Step 1: Update Apache Zookeeper Configuration]
...
:::accordion[Step 3: Configure the Collector]
...
:::accordion[Step 4: Run the Collector]
...
:::accordion[Collector Connection Issues]
