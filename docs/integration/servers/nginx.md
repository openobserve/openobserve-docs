...
:::accordion[Step 1: Configure NGINX to Emit JSON Logs]
...
:::accordion[Step 2: Install Fluent Bit]
...
:::accordion[Step 3: Configure Fluent Bit for NGINX Logs]
...
:::accordion[Step 4: Start Fluent Bit]
...
:::accordion[No logs appearing in OpenObserve?]
...
:::accordion[NGINX access log not updating?]
...
:::accordion[Fluent Bit not reading logs?]
