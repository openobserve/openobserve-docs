...
:::::accordion[Step 1. Create the EKS cluster]
...
:::::accordion[Step 2. Create the S3 bucket and IAM role]
...
::::accordion[Step 3. Install cluster dependencies]
...
:::::accordion[Step 4. Configure `values.yaml`]
...
::::accordion[Step 5. Install OpenObserve with Helm]
