---
title: Prometheus
description: Ingest metrics via Prometheus remote write using POST /api/{org}/prometheus/api/v1/write. Compatible with any tool supporting the spec.
---
...
You can follow the documentation to ingest metrics data: [Ingestion for metrics](index.md)
