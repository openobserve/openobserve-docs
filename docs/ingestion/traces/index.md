...
description: "Configure OpenTelemetry distributed tracing over HTTP or gRPC with OpenObserve for application performance monitoring and microservices observability."
---
