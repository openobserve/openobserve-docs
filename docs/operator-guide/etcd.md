        ...
        spec:
          ...
          - name: etcd
            ...
            - etcdctl='etcdctl';
              ...
              for i in 0 1 2;
              do
                etcdctl --endpoints="http://cloud1-etcd-$i.cloud1-etcd-headless.etcd.svc.cluster.local:2379" defrag --command-timeout=300s;
                etcdctl --endpoints="http://cloud1-etcd-$i.cloud1-etcd-headless.etcd.svc.cluster.local:2379" --write-out=table endpoint status;
                etcdctl --endpoints="http://cloud1-etcd-$i.cloud1-etcd-headless.etcd.svc.cluster.local:2379" alarm disarm;
                etcdctl --endpoints="http://cloud1-etcd-$i.cloud1-etcd-headless.etcd.svc.cluster.local:2379" alarm list;
              done;
              sleep 300
