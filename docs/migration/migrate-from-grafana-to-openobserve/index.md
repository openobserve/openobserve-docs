...
6. [Migrating Dashboards & Alerts](dashboards-and-alerts.md) — convert Grafana dashboards and alert rules with the migration tool
...
- [Migrating Dashboards & Alerts](dashboards-and-alerts.md) — convert Grafana dashboards and alert rules with the migration tool
