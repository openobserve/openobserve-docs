...
6. [Migrating Dashboards & Monitors](dashboards-and-alerts.md): convert Datadog dashboards and monitors with the migration tool
...
- **Dashboards & monitors:** export them via the Datadog API now so you have a static record to reconcile against after converting.
...
4. **Convert dashboards and monitors** with the [OpenObserve migration tool](https://migration.openobserve.ai/), which translates the queries to PromQL or SQL and maps layout and thresholds for you.
...
- [Migrating Dashboards & Monitors](dashboards-and-alerts.md): convert Datadog dashboards and monitors with the migration tool
