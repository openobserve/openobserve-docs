...
This variable dynamically fetches values from a selected field in a stream. It supports both [single-select and multi-select options](./variables-in-openobserve.md#single-select-and-multi-select).
