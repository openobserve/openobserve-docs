...
description: Visualize and monitor real-time or historical data in OpenObserve using dashboards, variables, comparisons, and custom interactive charts.
---
...
- [Custom Charts](custom-charts/index.md)
