...
description: Manage and customize OpenObserve Dashboards—add panels, adjust time ranges, auto-refresh, export, share, and edit settings for better data visibility.
---
