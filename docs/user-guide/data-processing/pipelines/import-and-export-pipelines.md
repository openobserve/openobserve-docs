---
title: Import and Export Pipelines
description: Import and export pipelines in OpenObserve to move configurations across environments easily using JSON files, URLs, or direct input.
---
