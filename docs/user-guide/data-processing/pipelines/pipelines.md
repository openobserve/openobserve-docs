---
title: Pipelines in OpenObserve
...
> For more details, refer to the [Create and Use Real-time Pipelines](./create-and-use-real-time-pipeline.md) guide. 
...
> For more details, refer to the [Create and Use Scheduled Pipelines](./create-and-use-scheduled-pipeline.md) guide. 
