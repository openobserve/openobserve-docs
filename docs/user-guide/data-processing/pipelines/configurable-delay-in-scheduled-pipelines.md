---
title: Configurable Delay in Scheduled Pipelines
description: Delay scheduled pipeline execution in OpenObserve to ensure data completeness by waiting minutes after the trigger time before processing data.
---

This guide explains how to use the configurable delay feature for [scheduled pipelines](create-and-use-scheduled-pipeline.md).
