---
title: Create and Use Real-time Actions
description: Create real-time Actions in OpenObserve to automate workflows with Python scripts triggered by log events or alerts—manual or automated scripts are supported.
---
...
:::accordion[Step 1: Create the Action Script]
...
:::accordion[Step 2: Compress the Script Folder into a ZIP File]
...
:::accordion[Step 3: Configure the Real-time Action]
...
:::accordion[Step 4: Select the Service Account]
...
:::accordion[Step 5: Add Environment Variables (optional)]
...
:::accordion[Step 6: Save the Real-time Action]
