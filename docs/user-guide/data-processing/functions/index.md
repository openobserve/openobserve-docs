...
description: Learn how to create, test, and apply VRL functions in OpenObserve to transform stream data during ingestion using the UI or API.
---
...
- [SQL References](../../../reference/sql-reference.md)
