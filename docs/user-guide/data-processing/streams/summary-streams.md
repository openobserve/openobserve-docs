---
title: Summary Streams
metaTitle: Summary Streams Guide for Optimizing OpenObserve Dashboards
...
:::accordion[Step 1: Analyze your existing panels]
...
:::accordion[Step 2: Identify common elements]
...
:::accordion[Step 3: Design your summary query]
```sql
SELECT 
...
:::accordion[Step 4: Create the summary pipeline]
...
:::accordion[Step 5: Update your panel queries]
...
:::accordion[Original dashboard loads data in `36.68 seconds`:]
![Original dashboard](../../../images/perf-original-dashboard.png)
:::
:::accordion[After updating the dashboard to use a summary stream, the load time reduced to `1.69 seconds`:]
![With summary stream](../../../images/perf-with-summary-stream.png)
:::
:::accordion[When running the original dashboard with aggregation cache enabled, the load time reduced to `1.16 seconds`:]
...
:::accordion[1. Data Delay Consideration]
...
:::accordion[1. Summary stream returns no data]
...
:::accordion[2. Results do not match original panels]
...
:::accordion[3. Summary stream grows too large]
...
:::accordion[4. Unable to confirm if the pipeline is running or failing]
