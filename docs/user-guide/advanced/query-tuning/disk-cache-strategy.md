---
title: Configure Disk Cache Eviction Strategy
description: Configure how OpenObserve evicts cached files on disk using LRU, FIFO, or time-based LRU strategies via the ZO_DISK_CACHE_STRATEGY setting.
---
