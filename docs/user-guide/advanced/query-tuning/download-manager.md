...
description: OpenObserve's Download Manager improves query speed by managing Parquet file downloads using a dual-queue system for recent and historical data.
---
...
:::::tabs
::::tab[Ingestion Download Queuing Across a Large Time Range]
...
::::
::::tab[Search Download Queuing Across a Long Time Range]
