...
> Before you begin, make sure you have the required access to use the [**Logs**](logs.md) page. .
> Ensure that at least one stream with data is available in your organization. Learn more about [streams](../../data-processing/streams/streams-in-openobserve.md). 
